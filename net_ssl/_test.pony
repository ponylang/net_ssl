...
class \nodoc\ iso _TestX509Certificate is UnitTest
  ...
  fun ref apply(h: TestHelper) =>
    try
      ...
      h.assert_eq[I64](certificate.not_before_posix(), 1692077427)
      h.assert_eq[I64](certificate.not_after_posix(), 1699853426)
      ...
      h.assert_eq[String](certificate.serial()?, "03288DF5383C17265802DE627C44C6D38535")
      ...
      h.assert_eq[String](mcert.issuer_name()?, "R3")
      h.assert_eq[String](mcert.subject_name()?, "ponylang.io")
      h.assert_eq[String](mcert.fingerprint_sha1(), "6F6E4D79A77B44D524F8C2FB62E46559B3FF7EB4")
      h.assert_eq[String](mcert.fingerprint_sha256(), "35E5ACDA20A72168E05E93813A4B62F91E9E2594A243FE73213F4323BA264BFF")
      h.assert_eq[String](mcert.fingerprint_md5(), "62AE902FC8BB8A66856CCC3A1066D663")
      h.assert_eq[I64](mcert.not_before_posix(), 1692077427)
      h.assert_eq[I64](mcert.not_after_posix(), 1699853426)
      h.assert_eq[String](mcert.authority_key_id()?, "14:2E:B3:17:B7:58:56:CB:AE:50:09:40:E6:1F:AF:9D:8B:14:C2:C6")
      h.assert_eq[String](mcert.key_id()?, "B5:4D:AD:EC:4A:57:BA:21:77:5B:0A:09:89:8C:91:51:D8:F3:36:0B")
      h.assert_eq[String](mcert.serial()?, "03288DF5383C17265802DE627C44C6D38535")
      h.assert_false(mcert.is_ca())
      h.assert_false(mcert.is_self_signed()?)
