...
class \nodoc\ iso _TestX509Certificate is UnitTest
  ...
  fun ref apply(h: TestHelper) =>
    try
      ...
      h.assert_eq[I64](certificate.not_before_posix(), 1692063027)
      ...
      h.assert_eq[I64](mcert.not_before_posix(), 1692063027)
      h.assert_eq[I64](mcert.not_after_posix(), 1699835426)
